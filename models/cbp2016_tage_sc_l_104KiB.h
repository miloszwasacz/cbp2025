...
// TAGE2016 with approximately the same size as Firestorm and Oryon
...
#define NBANKHIGH 15        // number of banks in the shared bank-interleaved for the  history lengths
...
int predictorsize (bool debug_print = true)
{
    int STORAGESIZE = 0;
    int inter = 0;
#ifdef PRINTSIZE
    ...
    if (debug_print) fprintf (stderr, " (LOOP %d) ", inter);
    STORAGESIZE += inter;
#endif
